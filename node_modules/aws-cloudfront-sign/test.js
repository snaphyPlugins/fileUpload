...
console.log(cf.getSignedUrl(
  'http://d37a477stcqjti.cloudfront.net/cats.jpg?my-other-param=jason&name=yoo', params))

console.log(cf.getSignedRTMPUrl(
  'd37a477stcqjti.cloudfront.net', 'cats.m4v', params))
